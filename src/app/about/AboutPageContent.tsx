    ...
    <>
      ...
      <section className="bg-blush py-14 lg:py-20 px-6" aria-labelledby="values-heading">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <p className="section-label mb-4">{about.valuesHeading}</p>
            <h2 id="values-heading" className="font-cormorant italic text-charcoal leading-none" style={{ fontSize: "clamp(3.5rem, 8vw, 7rem)" }}>{about.valuesLabel}</h2>
          </motion.div>
